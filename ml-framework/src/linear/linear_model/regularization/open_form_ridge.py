import numpy as np
from src.linear.linear_model.data_formats.linear_reg_data_classes import LinearRegressionParams
from src.linear.linear_model.data_formats.linear_reg_data_classes import LinearRegressionAttr
from src.linear.linear_model.linear_regression_abc import LinearEstimator
from src.utilities.metrics import check_if_loss_improved_more_than_tol
from src.utilities.metrics import check_if_coef_changed_more_than_tol
from src.utilities.metrics import MSE
from src.linear import log
